...
hist(EmployeeBiometric.df$SBPmmHg, main="Systolic Blood Pressure",col="orange", breaks=100)

plot(density(EmployeeBiometric.df$SBPmmHg, na.rm=TRUE),
     main="Systolic Blood PressureL", col="orange")

beanplot::beanplot(EmployeeBiometric.df$SBPmmHg, main="Systolic Blood Pressure", col="orange", what=c(0.85,0.85,0.85,0), overallline="mean", boxwex=0.75, horizontal=FALSE)

qqnorm(EmployeeBiometric.df$SBPmmHg,main="Systolic Blood Pressure",col="orange")
```
Variable DBPmmHg
```{r}
par(ask=TRUE)
